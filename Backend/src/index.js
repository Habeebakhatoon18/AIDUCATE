...
async function getYouTubeTranscript(videoId) {
    ...
    try {
        // Try to get cached transcript from Redis
        ...
        // If not cached, fetch from Apify actor
        const input = {
       ...
       // await redisClient.set(cacheKey, transcriptText, { EX: 86400 });
...
console.log("transcriptText type:", typeof transcriptText);
console.log("transcriptText value:", transcriptText);
